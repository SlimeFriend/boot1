...
public class UploadController {
	@Value("${file.upload.path}")// 환경변수 및 Properties 파일의 변수 값을 Read
			// 프로젝트 내 클래스에 있는 일반 변수가 아니라 컴퓨터 메모리 내의 변수를 가져옴
...
*/	
	...
	public String formUploadFile
		...
		for(MultipartFile file : files) {
			...
			System.out.println(String.valueOf(file.getSize()));
	...
	// 파일 다운로드 시 저장 경로에 같은 파일명이 있을 경우를 위한 코드
	@GetMapping("upload")
